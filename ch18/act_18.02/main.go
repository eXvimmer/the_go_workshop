...
// generateCert generates an ECDSA certificate and private key using the
// crypto/ecdsa library.
func generateCert(cn string, caCert *x509.Certificate, caPriv crypto.PrivateKey) (
